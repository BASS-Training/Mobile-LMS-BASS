...
class AppStrings {
  ...
  static const String noSavedCourses = 'No saved courses yet';
  ...
  static const String noCertificates = 'No certificates yet';
  ...
  static const String recentCourses = 'Recent Courses';
  static const String continueLearning = 'Continue Learning';

  static String helloWelcome = 'Hello, welcome to the app!';
  static String readyForLesson = 'You\'re ready for your next lesson!';
}
